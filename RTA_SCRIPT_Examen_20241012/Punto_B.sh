...
# Formateo las particiones creadas
...
# Agrego las entradas en /etc/fstab para montar las particiones
...
#actualizo la carpeta fstab
sudo systemctl daemon-reload
# Montar todas las particiones desde fstab
sudo mount -a
